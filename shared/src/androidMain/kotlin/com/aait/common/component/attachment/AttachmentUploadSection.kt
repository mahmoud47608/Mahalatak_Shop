package com.aait.common.component.attachment
...
import com.aait.common.picker.file.rememberFilePicker
import com.aait.common.picker.image.rememberImagePicker
...
fun AttachmentUploadSection(
    ...
    label: String = stringResource(Res.string.attachments),
    supportedFormatsText: String = stringResource(Res.string.supported_formats)
) {
    ...
    Column(
        ...
        Button(
            ...
            Text(
                text = stringResource(Res.string.browse_attachments),
