...
enum class AttachmentType(
    ...
    val defaultTitleRes: StringResource
) {
    IMAGE(Res.drawable.app_icon, Res.string.attach_image),
    PDF(Res.drawable.app_icon, Res.string.attach_file),
    VIDEO(Res.drawable.app_icon, Res.string.attach_video),
    FILE(Res.drawable.app_icon, Res.string.attach_file)
}
