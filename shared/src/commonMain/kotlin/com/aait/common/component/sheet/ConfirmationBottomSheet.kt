...
import com.aait.common.component.button.ButtonStyle
import com.aait.common.component.button.DefaultButton
...
fun ConfirmationBottomSheet(
    ...
    cancelText: String = stringResource(Res.string.no),
    onConfirm: () -> Unit,
    onDismiss: () -> Unit
) {
