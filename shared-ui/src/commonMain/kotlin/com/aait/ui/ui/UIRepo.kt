...
class UIRepo {
    ...
    suspend fun showMsg(messageKey: String, isKey: Boolean = true) {
        _uiMessage.emit(UIMessage.StringKey(messageKey))
    }

    private val _fcmUpdate =
        MutableSharedFlow<Map<String, String>>(replay = 0, extraBufferCapacity = 1)
