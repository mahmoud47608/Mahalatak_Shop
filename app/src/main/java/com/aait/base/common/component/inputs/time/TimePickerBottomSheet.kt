package com.aait.base.common.component.inputs.time
    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            Row(
                ...
                horizontalArrangement = Arrangement.spacedBy(PaddingDimensions.medium, Alignment.End)
            ) {
                TextButton(
                    onClick = {
                ...
                Button(
                    onClick = {
                        ...
                        val formatter = SimpleDateFormat(if (is24Hour) "HH:mm" else "hh:mm a", Locale.ENGLISH)
